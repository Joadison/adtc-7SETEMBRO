...
const SobreNos = () => {
  ...
  const historiaContent = (
    <div className="space-y-6">
      {/* <div className="relative h-48 md:h-64 flex justify-center items-center bg-white rounded-xl mb-6">
        <Image
          src="https://iiisjlgwrr.ufs.sh/f/R1WGWTYNvh5qZbTCNlFAW7QuoVdfNiOEvXS0jYe8km2atzC9"
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end">
          <div className="p-6 text-white">
            ...
            <p className="text-white/80">
              Uma jornada de fé, dedicação e serviço ao Reino de Deus
            </p>
          </div>
        </div>
      </div> */}
      ...
      <p className="indent-6 text-gray-700 leading-relaxed">
        ...
        história, é formada por &quot;muitas histórias&quot;: histórias de
        homens e de mulheres de Deus, das diversas gerações, em distintos
        lugares e realidades, que experimentaram o poder do Espírito Santo e
        realizaram a obra do Senhor no mundo. Temos uma história e ela conta a
        respeito de quem somos, o que cremos e o que fazemos.
      </p>
      <p className="indent-6 text-gray-700 leading-relaxed">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
        <div className="bg-orange-50 p-6 rounded-lg border border-orange-100">
          ...
          <p className="text-gray-700">
            Início do movimento pentecostal no Brasil
          </p>
        </div>
        <div className="bg-orange-50 p-6 rounded-lg border border-orange-100">
          <div className="text-orange-600 text-xl font-bold mb-2">1918</div>
          <p className="text-gray-700">
            Chegada da Assembleia de Deus ao Ceará
          </p>
        </div>
        <div className="bg-orange-50 p-6 rounded-lg border border-orange-100">
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row gap-8 mb-8">
        <div className="md:w-1/2">
          ...
          <p className="indent-6 text-gray-700 leading-relaxed">
            Nossa igreja, a Assembleia de Deus Templo Central é uma igreja
            cristã, evangélica e pentecostal, com mais de 100 anos de
            existência, localizada na cidade de Fortaleza, Estado do Ceará, que
            conta com mais de 250 congregações distribuídas por toda a Capital.
            Nossa igreja tem como visão ser uma comunidade fiel à proclamação e
            vivência do Evangelho, buscando ser relevante no contexto em que
            está inserida e que busca ser reconhecida como um lugar de
            Restauração, Misericórdia e Ensino.
          </p>
          <p className="indent-6 text-gray-700 leading-relaxed mt-4">
            ...
            multigeracional, multilocal, que crê na experiência do Pentecostes
            para nossos dias e busca comunicar de maneira íntegra e relevante o
  ...
  const feContent = (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-orange-50 to-orange-100 p-6 rounded-xl border border-orange-200 mb-8">
        ...
        <p className="text-gray-700 leading-relaxed">
          Nossa Igreja tem a Palavra de Deus como sua única norma de fé e
          prática para a vida cristã. Cremos em todas as verdades reveladas por
          Deus nas Escrituras Sagradas, seguindo a tradição do cristianismo
          evangélico e pentecostal ao longo dos séculos. Como uma igreja
          pentecostal, Nossa Igreja crê na experiência do batismo com o Espírito
          Santo e na atualidade dos dons espirituais na vida do crente.
        </p>
        <p className="text-gray-700 leading-relaxed mt-4">
          Historicamente, as Assembleias de Deus têm sintetizado a fé
          pentecostal na seguinte declaração: &quot;Jesus salva, cura, batiza
        ...
        <div className="p-6">
          <ol className="list-decimal space-y-4 pl-6">
            <li className="text-gray-700 leading-relaxed">
              Na inspiração divina verbal e plenária da Bíblia Sagrada, única
              regra infalível de fé e prática para a vida e o caráter cristão
              (2Tm 3.14-17);
            </li>
            <li className="text-gray-700 leading-relaxed">
              Em um só Deus, eternamente subsistente em três pessoas distintas
              que, embora distintas, são iguais em poder, glória e majestade: o
              Pai, o Filho e o Espírito Santo; Criador do Universo, de todas as
              coisas que há nos céus e na terra, visíveis e invisíveis, e, de
            ...
            <li className="text-gray-700 leading-relaxed">
              No Senhor Jesus Cristo, o Filho Unigênito de Deus, plenamente
              Deus, plenamente Homem, na concepção e no seu nascimento virginal,
              em sua morte vicária e expiatória, em sua ressurreição corporal
              dentre os mortos e em sua ascensão vitoriosa aos céus como
              Salvador do mundo (Jo 3.16-18; Rm 1.3,4; Is 7.14; Mt 1.23; Hb
            ...
            <li className="text-gray-700 leading-relaxed">
              ...
              povo (2Co 13.13; 2Co 3.6,17; Rm 8.2; Jo 16.11; Tt 3.5; 2Pe 1.21 e
              Jo 16.13);
            </li>
            <li className="text-gray-700 leading-relaxed">
              ...
              de Jesus Cristo podem restaurá-lo a Deus (Rm 3.23; At 3.19);
            </li>
            <li className="text-gray-700 leading-relaxed">
              Na necessidade absoluta do novo nascimento pela graça de Deus
              mediante a fé em Jesus Cristo e pelo poder atuante do Espírito
              Santo e da Palavra de Deus para tornar o homem aceito no Reino dos
              Céus (Jo 3.3-8, Ef 2.8,9);
            </li>
            <li className="text-gray-700 leading-relaxed">
              No perdão dos pecados, na salvação plena e na justificação pela fé
              no sacrifício efetuado por Jesus Cristo em nosso favor (At 10.43;
              Rm 10.13; 3.24-26; Hb 7.25; 5.9);
            </li>
            <li className="text-gray-700 leading-relaxed">
              Na Igreja, que é o corpo de Cristo, coluna e firmeza da verdade,
              una, santa e universal assembleia dos fieis remidos de todas as
              eras e todos os lugares, chamados do mundo pelo Espírito Santo
              para seguir a Cristo e adorar a Deus (1Co 12.27; Jo 4.23; 1Tm
              3.15; Hb 12.23; Ap 22.17);
            </li>
            <li className="text-gray-700 leading-relaxed">
              No batismo bíblico efetuado por imersão em águas, uma só vez, em
              nome do Pai, e do Filho, e do Espírito Santo, conforme determinou
              o Senhor Jesus Cristo (Mt 28.19; Rm 6.1-6; Cl 2.12);
            </li>
            <li className="text-gray-700 leading-relaxed">
              Na necessidade e na possibilidade de termos vida santa e
              irrepreensível por obra do Espírito Santo, que nos capacita a
              viver como fiéis testemunhas de Jesus Cristo (Hb 9.14; 1Pe 1.15);
            </li>
            <li className="text-gray-700 leading-relaxed">
              No batismo com o Espírito Santo, conforme as Escrituras, que nos é
              dado por Jesus Cristo, demonstrado pela evidência física do falar
              em outras línguas, conforme a sua vontade (At 1.5; 2.4; 10.44-46;
              19.1-7);
            </li>
            <li className="text-gray-700 leading-relaxed">
              Na atualidade dos dons espirituais distribuídos pelo Espírito
              Santo à Igreja para sua edificação, conforme Sua soberana vontade
              para o que for útil (1Co 12.1-12);
            </li>
            <li className="text-gray-700 leading-relaxed">
              ...
              glorificada, para reinar sobre o mundo durante mil anos (1Ts 4.16,
              17; 1Co 15.51-54; Ap 20.4; Zc 14.5; Jd 14);
            </li>
            <li className="text-gray-700 leading-relaxed">
              No comparecimento ante o Tribunal de Cristo de todos os cristãos
              arrebatados, para receberem a recompensa pelos seus feitos em
              favor da causa de Cristo na Terra (2Co 5.10);
            </li>
            <li className="text-gray-700 leading-relaxed">
              No Juízo Final, no qual comparecerão todos os ímpios: desde a
              Criação até o fim do Milênio; os que morreram durante o período
            ...
            <li className="text-gray-700 leading-relaxed">
              Cremos, também, que o casamento foi instituído por Deus e
              ratificado por nosso Senhor Jesus Cristo como união entre um homem
              e uma mulher, nascidos macho e fêmea, respectivamente, em
              conformidade com o definido pelo sexo da criação geneticamente
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <Card className="border-orange-200 hover:border-orange-300 transition-colors">
          <CardContent className="pt-6">
            ...
            <p className="text-gray-700 leading-relaxed">
              Nossa Igreja tem como visão ser &quot;uma comunidade que seja fiel
              à proclamação e a vivência do Evangelho de Cristo, relevante no
              contexto social, reconhecida como um lugar de Restauração,
              Misericórdia e Ensino&quot;.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-orange-200 hover:border-orange-300 transition-colors">
          <CardContent className="pt-6">
            ...
            <p className="text-gray-700 leading-relaxed">
              Nossa Igreja tem por missão &quot;fazer discípulos e conduzi-los a
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg">
              ...
              <p className="text-white/80">
                ...
                seguindo o maior mandamento de Cristo.
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-2">Acolher</h3>
              <p className="text-white/80">
                Receber a todos com o amor de Cristo, sem distinção, criando um
                ambiente de comunhão e pertencimento.
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-2">Servir</h3>
              <p className="text-white/80">
                Servir a Deus e ao próximo com excelência, humildade e
                dedicação, seguindo o exemplo de Jesus.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto">
            Conheça mais sobre a Assembleia de Deus Templo Central - 7 de
            Setembro, nossa história, nossa fé e nossos valores que nos guiam há
            mais de um século.
          </p>
        </div>
